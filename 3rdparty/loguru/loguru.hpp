...
#define VLOG_F(verbosity, ...) \
    ((verbosity) > loguru::current_verbosity_cutoff()) ? (void)0 : loguru::log(verbosity, __FILE__, __LINE__, __VA_ARGS__)
...
#define VLOG_IF_F(verbosity, cond, ...) \
    ((verbosity) > loguru::current_verbosity_cutoff() || (cond) == false) ? (void)0 : loguru::log(verbosity, __FILE__, __LINE__, __VA_ARGS__)
...
#define RAW_VLOG_F(verbosity, ...) \
    ((verbosity) > loguru::current_verbosity_cutoff()) ? (void)0 : loguru::raw_log(verbosity, __FILE__, __LINE__, __VA_ARGS__)
...
#define VLOG_IF_S(verbosity, cond) \
    ((verbosity) > loguru::current_verbosity_cutoff() || (cond) == false) ? (void)0 : loguru::Voidify() & loguru::StreamLogger(verbosity, __FILE__, __LINE__)
...
#define DVLOG_IF_S(verbosity, cond) \
    (true || (verbosity) > loguru::current_verbosity_cutoff() || (cond) == false) ? (void)0 : loguru::Voidify() & loguru::StreamLogger(verbosity, __FILE__, __LINE__)
